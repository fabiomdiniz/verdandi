...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Jet black and electric blue.">
...
<header class="jumbotron subhead" id="overview">
  ...
  <div class="subnav">
    <ul class="nav nav-pills">
      <li><a href="#typography">Summary of the Last Battle</a></li>
      <li><a href="#navbar">Next Strategy</a></li>
      <li><a href="#buttons">Top Generals</a></li>
